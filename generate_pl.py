"""
generate_pl.py — Nowy Sącz weather dashboard (Polish version)
Fetches wttr.in JSON, produces pl/index.html.
...
<div class="card">
  <div class="header">
    <div class="hdr-left">
      ...
      <div class="hdr-mid">
        <div class="hdr-location">&#x1F4CD; Nowy S&#x105;cz, Polska</div>
...
print(f"pl/index.html written — {cur_temp}°C {cur_desc}, pewność {conf_pct}%")
